			...
			<b-card>
				<div slot="header">
					<div class="d-flex align-items-center justify-content-between">
						<h6 class="mb-0 h5 text-truncate">Stock Details</h6>
						...
						>
							<div class="row align-items-center">
								...
								<div class="col-12 col-sm-5">
									...
									<template v-if="editGardenDetails">
										<b-form-input
											v-if="gardendetail.type == 'text' && (gardendetail.name == 'product_quantity_left' || gardendetail.name == 'product_price')"
...
export default {
	...
	methods: {
		...
		updateGardenDetail() {
			this.spinner = true;
			axios
				.put(`/lot/${this.uuid}`, this.gardendata)
				.then(response => {
					this.spinner = false;
