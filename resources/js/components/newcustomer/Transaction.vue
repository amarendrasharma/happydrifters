<template>
	<div class="py-4">
		<h4 class="mb-4">Invoices for {{products[0].customer.customer_name}}</h4>  
		<b-row>
			<b-col sm="6">
                ...
                <tbody>
                    <tr v-for="invoice in products" :key="invoice.id">
                        <td>
                            ...
                            class="no-underline text-red hover:text-red-dark" title="view details">{{ invoice.invoice_no }} 
                            <span>&rarr;</span>
                            </router-link>
                        </td> 
                        ...
                        <td class="small">
                            ...
                            <span class="small text-muted">{{ invoice.customer.customer_phone }}</span>
                        </td>
                        <td class="small text-right">{{ invoice.total_rounded_amount_payable | currency('&#8377;') }}</td>
